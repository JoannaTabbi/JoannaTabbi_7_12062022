      ...
      <div class="row align-items-center text-center text-md-start">
        <div class="col-12 col-md-4">
          ...
          <ul class="list-unstyled">
            ...
            <li class="list-item">
              <router-link to="">Gestion de cookies</router-link>
            </li>
          </ul>
        </div>
        <div class="col-12 col-md-4">
          ...
          <ul class="list-unstyled">
            <li class="list-item">
              <router-link to="">Centre d'aide</router-link>
            </li>
            <li class="list-item">
              <router-link to="">Accessibilité</router-link>
            </li>
            <li class="list-item">
              <a href="mailto:contact@groupomania.com">Nous contacter</a>
            </li>
          </ul>
        </div>
        <div class="col-12 col-md-4">
